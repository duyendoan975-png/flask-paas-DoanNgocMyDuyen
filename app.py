...
def info():
  ...
  return {
      ...
      "nguon_du_lieu": "Environment Variable tren Render, KHONG hardcode",
  }


@app.route("/")
def home():
  # Định nghĩa CSS riêng để tránh lỗi cú pháp dấu ngoặc nhọn trong f-string
  css = """
  ...
  return f"""
    ...
    <body>
        ...
        <div class="box">
            <p><b>Sinh vien:</b> DUYEN - 233404050169</p>
